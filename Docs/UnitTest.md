...
| C-A-04  |  A-04  |        AuthController.login()         |
| C-A-05  |  A-05  |       AuthController.refresh()        |
| C-A-06  |  A-06  |        AuthController.logout()        |
...
| C-A-01-02 | Exception occurred | 서비스에서 예외가 발생하여 실패한다. | 컨트롤러가 예외를 던진다.        |
...
| C-A-02-02 | Exception occurred | 서비스에서 예외가 발생하여 실패한다. | 컨트롤러가 예외를 던진다.        |
...
| C-A-03-02 | Exception occurred | 서비스에서 예외가 발생하여 실패한다. | 컨트롤러가 예외를 던진다.        |

#### [C-A-04]: AuthController.login()

|  Test ID  |        Name        | Summary                              | Expected result                  |
| :-------: | :----------------: | :----------------------------------- | :------------------------------- |
| C-A-04-01 |      Success       | 예외 발생 없이 로그인에 성공한다.    | 컨트롤러가 성공 응답을 반환한다. |
| C-A-04-02 | Exception occurred | 서비스에서 예외가 발생하여 실패한다. | 컨트롤러가 예외를 던진다.        |

#### [C-A-05]: AuthController.refresh()

|  Test ID  |        Name        | Summary                              | Expected result                  |
| :-------: | :----------------: | :----------------------------------- | :------------------------------- |
| C-A-05-01 |      Success       | 예외 발생 없이 로그인에 성공한다.    | 컨트롤러가 성공 응답을 반환한다. |
| C-A-05-02 | Exception occurred | 서비스에서 예외가 발생하여 실패한다. | 컨트롤러가 예외를 던진다.        |

#### [C-A-06]: AuthController.logout()

|  Test ID  |        Name        | Summary                              | Expected result                  |
| :-------: | :----------------: | :----------------------------------- | :------------------------------- |
| C-A-06-01 |      Success       | 예외 발생 없이 로그인에 성공한다.    | 컨트롤러가 성공 응답을 반환한다. |
| C-A-06-02 | Exception occurred | 서비스에서 예외가 발생하여 실패한다. | 컨트롤러가 예외를 던진다.        |
